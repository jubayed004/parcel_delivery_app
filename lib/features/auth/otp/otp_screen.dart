...
class OtpScreen extends StatefulWidget {
  ...
  @override
  State<OtpScreen> createState() => _authScreenState();
}
class _authScreenState extends State<OtpScreen> {
          ...
          child: Column(
            children: [
              ...
              CustomButton(
                ...
                onTap: ()=>AppRouter.route.pushNamed(RoutePath.resetPasswordScreen),
              ),
